    ...
    <table class="data-table" border="1">
        <thead>
            ...
            <tr>
                ...
                @endif
                <th style="width: 100px;">{{ $showingApproved ? 'Date Approved' : 'Date Filed' }}</th>
            </tr>
        </thead>
        <tbody>
            @php
            ...
            $school = optional($grant->school)->shortname ?? optional($grant->school)->name ?? 'ZZZZ';
