...
import { formatName, formatDate, formatGrantProvision, isJpm, groupRecords } from './report-helpers';
...
<template>
    <div>
            ...
            <table class="report-table">
                <thead>
                    <tr>
                        ...
                        <th v-if="options.includeGrantProvision">Grant Provision</th>
                        <th class="nowrap">Date Approved</th>
                ...
                <tbody>
                    <tr v-for="(rec, idx) in records" :key="idx"
                        ...
                        <td class="nowrap">{{ formatDate(rec.date_approved) }}</td>
                        <td v-if="options.includeRemarks" v-safe-html="rec.remarks || ''"></td>
                    </tr>
                </tbody>
            </table>
            <div class="group-total">Total Completed Scholars: {{ records.length }}</div>
        </template>
        ...
        <div class="report-footer">
            ...
            <span>Total: {{ records.length }} completed scholars</span>
        </div>
    </div>
</template>
