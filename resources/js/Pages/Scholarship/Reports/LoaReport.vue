    ...
    <div>
        <div class="report-header">
            ...
            <div class="report-header-text">
                <h1>SCHOLARS ON LEAVE OF ABSENCE</h1>
                <h2>Detailed List</h2>
            </div>
            <div class="report-header-logos">
            ...
            <table class="report-table">
                ...
                <tbody>
                    <tr v-for="(rec, idx) in records" :key="idx"
                        ...
                        <td v-safe-html="rec.loa_reason || rec.remarks || ''"></td>
                    </tr>
                </tbody>
            </table>
            <div class="group-total">Total Scholars on LOA: {{ records.length }}</div>
        </template>
        ...
        <div class="report-footer">
            ...
            <span>Total: {{ records.length }} scholars on leave</span>
        </div>
    </div>
</template>
