...
<template>
    <div>
            ...
            <table class="report-table">
                <thead>
                    <tr>
                        ...
                        <th class="nowrap">Interview Date</th>
                ...
                <tbody>
                    <tr v-for="(rec, idx) in records" :key="idx"
                        ...
                        <td class="nowrap">{{ formatDate(rec.interviewed_at) }}</td>
                        <td v-if="options.includeRemarks">{{ rec.remarks || '' }}</td>
                    </tr>
                </tbody>
            </table>
            <div class="group-total">Total Interviewed: {{ records.length }}</div>
        </template>
        ...
        <div class="report-footer">
            ...
            <span>Total: {{ records.length }} interviewed applicants</span>
        </div>
    </div>
</template>
