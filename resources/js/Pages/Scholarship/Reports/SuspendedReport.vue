...
<template>
    <div>
            ...
            <table class="report-table">
                <thead>
                    <tr>
                        ...
                        <th>Suspension Reason / Remarks</th>
                    </tr>
                </thead>
                <tbody>
                    <tr v-for="(rec, idx) in records" :key="idx"
                        ...
                        <td v-safe-html="rec.suspension_reason || rec.remarks || ''"></td>
                    </tr>
                </tbody>
            </table>
            <div class="group-total">Total Suspended Scholars: {{ records.length }}</div>
        </template>
        ...
        <div class="report-footer">
            ...
            <span>Total: {{ records.length }} suspended scholars</span>
        </div>
    </div>
</template>
