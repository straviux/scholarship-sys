                        ...
                        <Card class="w-full ios-page-panel">
                            <template #content>
                                    ...
                                    <div class="flex items-start gap-3">
                                        ...
                                        <div class="flex-1">
                                            ...
                                            <div class="text-sm text-blue-800 space-y-1">
                                                ...
                                                <p v-if="update.expires_at"><strong>Expires:</strong> {{
                                                    update.expires_at
                                                    }}
                                                </p>
                                            </div>
                                ...
                                <div class="border-b border-gray-200 pb-4 short:pb-2 mb-4 short:mb-2">
                                    ...
                                    <!-- Title -->
                                    <h1 class="text-3xl short:text-xl font-bold text-gray-900 mb-4">{{ update.title }}
                                    </h1>
                                ...
                                <div
                                    ...
                                    <div class="flex gap-2 flex-wrap">
                                        ...
                                        <AppButton v-else @click="reactivateUpdate" label="Reactivate"
                                            severity="success" icon="eye" outlined size="small" />
