...
<template>
    ...
    <AdminLayout>
                        ...
                        <TableRow v-for="(permission, index) in permissions" :key="permission.id">
                            ...
                            <TableDataCell
                                ...
                                <Link :href="route('permissions.edit', permission.id)
                                    " class="text-purple-500 hover:text-purple-600">Edit</Link>
        ...
        <Modal marginTop="md" maxWidth="lg" :show="showConfirmDeletePermissionModal" @close="closeModal">
            <div class="p-6">
                ...
                <div class="mt-6 flex space-x-4">
                    <DangerButton @click="deletePermission(modalPermissionData.id)">
                        Delete</DangerButton>
