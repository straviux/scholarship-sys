<template>
    <InterviewedApplicantsTemplate :records="records" report-type="list" :group-by="groupBy" :today="today"
        ...
        :include-interview-columns="true"
        :include-projected-columns="true" />
</template>

<script setup>
import { computed } from 'vue';

import InterviewedApplicantsTemplate from './InterviewedApplicantsTemplate.vue';
...
const resolvedReportTitle = computed(() => {
    return props.reportTitle?.trim() || 'RECOMMENDATION LIST FOR APPROVAL';
});
</script>