                                ...
                                <form @submit.prevent="submit">
                                    ...
                                    <div class="mt-4">
                                        <div class="w-full">
                                            ...
                                            <!-- 
                                            <TextInput id="school_name" type="text" class="mt-1 block w-full uppercase"
                                    ...
                                    <div class="mt-4 flex justify-between gap-4">
                                        <div class="w-1/2">
                                            ...
                                            <VueMultiselect v-model="form.academic_year" :options="academic_years"
                                                id="acadyear" :close-on-select="true" placeholder="" label="label"
                                                track-by="label" class="mt-1" />
                                        ...
                                        <div class="w-1/2">
                                            ...
                                            <VueMultiselect v-model="form.term" :options="terms" :close-on-select="true"
                                                placeholder="" label="label" track-by="label" class="mt-1" />
...
const submit = () => {
    ...
    form.post(route("scholarship_records.store"), {
        onSuccess: () => {
            form.reset();
            toast.success("Scholarship has been added", {
                position: toast.POSITION.TOP_RIGHT,
            });
            router.visit(route('profile.index', { id: props.profile_id, action: 'view' }))
        },
        onError: (err) => {
