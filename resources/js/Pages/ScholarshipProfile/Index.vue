...
import GenerateReportModal from '@/Pages/Applicants/GenerateReportModal.vue';
            ...
            <Table class="border-collapse border border-slate-100 bg-[#f8f8f8]" :loading="form.processing">
                ...
                <template #default>
                    ...
                    <TableRow class="hover:bg-gray-200" v-for="(profile, index) in profiles.data"
                        ...
                        <TableDataCell
                            class="border-collapse border-t border-l border-slate-400 text-gray-700 uppercase">
                            <div class="px-2"> {{ profile.scholarship_grant[0]?.date_approved ?
                                moment(profile.scholarship_grant[0].date_approved)
                                    .format('MMM DD, YYYY')
                                :
                                '-' }}</div>
                        </TableDataCell>
