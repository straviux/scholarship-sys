...
<template>
    ...
    <div class="h-full flex">
        ...
        <aside class="border-r border-slate-800 bg-[#0b0d13] transition-all duration-200 flex flex-col"
            ...
            <div class="flex-1 overflow-y-auto px-2 py-2 space-y-1">
                ...
                <div v-for="c in conversations" :key="c.id"
                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <div class="text-3xs text-slate-500">{{ formatRelative(c.updated_at) }}</div>
                    </div>
            ...
            <!-- Status footer -->
            <div class="border-t border-slate-800 px-3 py-2 text-3xs text-slate-500 space-y-0.5">
        ...
        <div class="flex-1 flex flex-col min-w-0 max-w-4xl mx-auto w-full px-4 py-4">
            ...
            <div ref="scrollEl" class="flex-1 overflow-y-auto space-y-4 pr-1">
                <template v-for="(m, i) in messages" :key="i">
                    <div class="flex" :class="m.role === 'user' ? 'justify-end' : 'justify-start'">
                        <div class="max-w-[85%] rounded-2xl px-4 py-2.5 text-sm leading-relaxed shadow" :class="m.role === 'user'
            ...
            <div class="mt-4">
                ...
                <p class="text-2xs text-slate-500 mt-1.5 px-2">
