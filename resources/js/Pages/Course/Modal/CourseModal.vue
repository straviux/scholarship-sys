...
<template>
    <Dialog :visible="isOpen" modal :header="props.action == 'create' ? 'Create Course Form' : 'Edit Course Form'"
        :style="{ width: '600px' }" @update:visible="closeModal">
        <form @submit.prevent="submit" class="mt-4">
            <div class="mt-4">
                <div class="w-full">
                    <InputLabel for="program" value="Program" />
                    <Select v-model="form.scholarship_program_id" :options="props.scholarshipProgramsOptions"
                        optionLabel="label" optionValue="value" placeholder="Select Program" class="w-full mt-1" />
