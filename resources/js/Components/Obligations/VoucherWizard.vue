                                ...
                                <div class="space-y-4">
                                    ...
                                    <div>
                                        ...
                                        <Select v-model="selectedParticularId"
                                            ...
                                            <template #option="{ option }">
                                                <span>{{ option.name }}<span v-if="formatParticularPrograms(option)"
                                                        class="text-gray-400"> - {{ formatParticularPrograms(option)
                                                        }}</span></span>
                                            </template>
                                            <template #value="{ value }">
                                                <template v-if="selectedParticular">
                                                    <span>{{ selectedParticular.name }}<span
                                                            v-if="formatParticularPrograms(selectedParticular)"
                                                            class="text-gray-400"> - {{
                                                                formatParticularPrograms(selectedParticular) }}</span></span>
                                                </template>
