...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('scholarship_record_attachments', function (Blueprint $table) {
            ...
            $table->enum('attachment_type', ['contract', 'requirements'])->comment('Type of attachment');
            $table->string('attachment_name')->comment('Custom name for the attachment');
